package com.exampleqian.demo_qianduan.entity;
...
public class faq {
    ...
    public faq(int id, String faqName, String faqDescription, String faqInfo, String faqSoftware) throws ParseException {
        this.id = id;
